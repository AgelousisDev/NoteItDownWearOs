...
object Dependencies {
    ...
    val composeMaterialIconsCore by lazy { "androidx.compose.material:material-icons-core:${Versions.COMPOSE_MATERIAL_ICONS_VERSION}" }
    val composeMaterialIconsExtended by lazy { "androidx.compose.material:material-icons-extended:${Versions.COMPOSE_MATERIAL_ICONS_VERSION}" }
